...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("p", null, toDisplayString(_ctx.msg), 1)
  ]);
}
...
const FhHelloWorld = withInstall(HelloWorld);
export { FhHelloWorld, FhHelloWorld as default, propsTypes, withInstall };
